...
function pagination( $total, $perPage, $url )
{
	...
	if (file_exists(ROOT . '/template/' . $_SESSION['user']['template'] . '/customize/pagination.php')) {
		include_once(ROOT . '/template/' . $_SESSION['user']['template'] . '/customize/pagination.php');
