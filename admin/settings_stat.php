...
if (isset($_POST['send'])) {
	...
	//IMAGES
	$TempSet['stat']['use_preview'] = (!empty($_POST['use_preview'])) ? 1 : 0;
	$TempSet['stat']['use_watermarks'] = (!empty($_POST['use_watermarks'])) ? 1 : 0;
...
<input type="checkbox" name="use_preview" value="1" <?php echo (!empty($set['stat']['use_preview'])) ? 'checked="checked"' : ''; ?> /><br></td></tr>

<tr><td class="left">Водяные знаки:<br></td>
<td><input type="checkbox" name="use_watermarks" value="1" <?php if(!empty($set['stat']['use_watermarks']) && $set['stat']['use_watermarks'] == 1) echo 'checked="checked"'; ?>></td></tr>
...
<input type="text" name="img_size_x" style="width: 40px" value="<?php echo $set['stat']['img_size_x'] ?>">x<input type="text" name="img_size_y" style="width: 40px" value="<?php echo $set['stat']['img_size_y'] ?>"></td></tr>
